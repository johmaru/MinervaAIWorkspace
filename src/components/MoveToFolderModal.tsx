...
export function MoveToFolderModal({
  ...
  return (
    <div
      ...
      onClick={onClose}
      role="dialog"
      aria-label={t("moveModal.title")}
    >
      <div
        className="max-h-[85vh] w-full max-w-md overflow-y-auto rounded-3xl bg-popover p-6 ring-1 ring-border animate-[modal-in_0.2s_ease-out]"
